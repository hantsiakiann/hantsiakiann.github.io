...
document.getElementById("county-rating").innerHTML = pres_pred["all"].ENRating;
	...
	if (key != "all") {
  		...
  		document.getElementById(pres_pred[key].Class).addEventListener("mouseenter",
  			(event) => {event.target.style.fill = pres_pred[key].Hover;
  				document.getElementById("presidential-constituency").innerHTML = pres_pred[key].English.concat('<div id="county-rating"></div>');
  				document.getElementById("county-rating").innerHTML = pres_pred[key].ENRating;
